...
h3n2sample <- h3n2sample %>% dplyr::group_by(clade) %>% dplyr::sample_frac(.1)
h3n2sample <- h3n2sample %>% dplyr::distinct(sequence,.keep_all=T)
...
mh.matrix.ha <- similarityMH(h3n2sample$sequence,k=4,n_hash=500) # rcpp min hash
pa.matrix.ha <- similarityNW(h3n2sample$sequence) # rcpp pairwise alignment
